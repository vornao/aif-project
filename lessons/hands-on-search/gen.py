...
def random_search(game_map: np.ndarray, start: Tuple[int, int], target: Tuple[int, int]) -> List[Tuple[int, int]]:
    ...
    while open_list:
        ...
        current, current_cost = open_list.pop() # il primo parametro è la priorità che ora non ci interessa    
...
def true_random_search(game_map: np.ndarray, start: Tuple[int, int], target: Tuple[int, int]) -> List[Tuple[int, int]]:
...
def true_random_nsteps(game_map: np.ndarray, start: Tuple[int, int], target: Tuple[int, int]) -> List[Tuple[int, int]]:
